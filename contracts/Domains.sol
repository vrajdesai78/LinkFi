...
contract Domains is ERC721URIStorage {
    ...
    // records to store values
    mapping(string => string) public records;

    // Struct to store transaction details for each address
    struct Transaction {
        address from;
        string txn;
        string matic;
    ...
    // Function to five the price of the domain based on length
    ...
    function register(string calldata name) public payable {
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the domain name service", "image": "data:image/svg+xml;base64,',
    ...
    function setRecord(string calldata addr, string calldata record) public {
        records[addr] = record;
        console.log("%s has set a record!", msg.sender);
    }

    function setTransaction(
        address to,
        string calldata txn,
        string calldata matic,
        ...
        console.log("%s has set a transaction!", msg.sender);
    }

    function getRecord(string calldata addr)
        public
        view
    ...
    function getTransactions(address addr)
        public
        view
